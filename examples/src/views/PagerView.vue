<template>
  <div>
    ...
    <stark-pager :total="20" :current-page="currentPage1" @current-change="changeHandle1"/>
    <p>总页码数 total 小于等于页码最大显示数 pager-count，可以全部显示</p>
    <stark-pager :total="10" :current-page="currentPage2" @current-change="changeHandle2"/>
    <p>页码最大显示数 pager-count 是可以调整的</p>
    <stark-pager :total="15" :current-page="currentPage3" :pager-count="15" @current-change="changeHandle3"/>
  </div>
</template>
